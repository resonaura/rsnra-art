...
${BAND_NAME} is an alternative rock band out of ${BAND_LOCATION}.

Fuzzed-out guitars, atmospheric synths, and rhythms built for
basement shows and big rooms alike — RESONAURA channels the grey
skies and neon nights of the Pacific Northwest into anthemic,
emotionally-charged rock.

New music, tour dates, and everything else lives at:
...
-------------------------------------
Thanks for stopping by. Turn it up.
`;
